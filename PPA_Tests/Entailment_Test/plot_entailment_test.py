...
if folder ==  './Result':
    Ordered_table = OrderedDict([
            ...
            # ('IMDB',OrderedDict([
            #     ('CNN',OrderedDict([ ('PAA',[]),('TextFooler',[]),('SememePSO',[]),('TextFooler/PAA',[]),('SememePSO/PAA',[])])),
            #     ('LSTM',OrderedDict([ ('PAA',[]),('TextFooler',[]),('SememePSO',[]),('TextFooler/PAA',[]),('SememePSO/PAA',[])])),
            ...
            ('MNLI',OrderedDict([
                ('BERT',OrderedDict([ ('PAA',[]),('TextFooler',[]),('TextFooler/PAA',[]),('SememePSO',[]),('SememePSO/PAA',[])])),
                ('DistilBERT',OrderedDict([ ('PAA',[]),('TextFooler',[]),('TextFooler/PAA',[]),('SememePSO',[]),('SememePSO/PAA',[])])),
                ]),
            ),
            ('SNLI',OrderedDict([
                ('BERT',OrderedDict([ ('PAA',[]),('TextFooler',[]),('TextFooler/PAA',[]),('SememePSO',[]),('SememePSO/PAA',[])])),
