...
def attack_setup(model_used,recipe,emb_size,total_list_char):
    ...
    if recipe =='punctuation_attack':
        print ('total letters',total_list_char)
        letters_to_insert = total_list_char[:emb_size+1]
        print ('current letters',letters_to_insert)
        ...
        # We'll constrain modification of already modified indices and stopwords randompunc = False randompos = true
        ...
        constraints.append(input_column_modification)
    elif recipe =='punctuation_attack_all_char_false':
        print ('total letters',total_list_char)
        letters_to_insert = total_list_char[:emb_size+1]
        print ('current letters',letters_to_insert)
        transformation = WordSwapTokenSpecificPunctuationInsertion(all_char = False, random_one=True,skip_first_char=True, skip_last_char=False,letters_to_insert=letters_to_insert)
        # We'll constrain modification of already modified indices and stopwords  randompunc = True randompos = True
        constraints = [RepeatModification(), StopwordModification(stopwords=stopwords),UniversalSentenceEncoder(threshold=0.8)]
        input_column_modification = InputColumnModification(
            ["premise", "hypothesis"], {"premise"}
        )
        ...
        constraints.append(input_column_modification)
    elif recipe =='punctuation_attack_random_false':
        print ('total letters',total_list_char)
        letters_to_insert = total_list_char[:emb_size+1]
        print ('current letters',letters_to_insert)
        transformation = WordSwapTokenSpecificPunctuationInsertion(all_char = True, random_one=False,skip_first_char=True, skip_last_char=False,letters_to_insert=letters_to_insert)
        ...
        constraints.append(input_column_modification)
    elif recipe =='punctuation_attack_all_false':
        print ('total letters',total_list_char)
        letters_to_insert = total_list_char[:emb_size+1]
        print ('current letters',letters_to_insert)
        transformation = WordSwapTokenSpecificPunctuationInsertion(all_char = False, random_one=False,skip_first_char=True, skip_last_char=False,letters_to_insert=letters_to_insert)
        # We'll constrain modification of already modified indices and stopwords   randompunc = True randompos = false
        constraints = [RepeatModification(), StopwordModification(stopwords=stopwords),UniversalSentenceEncoder(threshold=0.8)]
        input_column_modification = InputColumnModification(
            ["premise", "hypothesis"], {"premise"}
        )
